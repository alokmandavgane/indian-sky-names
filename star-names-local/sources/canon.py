...
EXTRA = [
    # The IAU constellations of the 1993 Hindi nomenclature (Muley) and the
    # 1892 Marathi set (Jambhekar/Dikshit). Minor figures precede the greedy
    # patterns: hydrus before hydra, triangulum australe before triangulum.
    ("leo-minor", r"leo minor"), ("bootes", r"bo[oö]tes"), ("ara", r"\bara\b|the altar"),
    ("canis-minor", r"canis minor"), ("hydrus", r"hydrus"),
    ("triangulum-australe", r"triangulum australe"), ("triangulum", r"triangulum"),
    ("piscis-austrinus", r"piscis austr"), ("corona-borealis", r"corona borealis"),
    ("perseus", r"perseus"), ("andromeda", r"andromeda"), ("cepheus", r"cepheus"),
    ("cetus", r"\bcetus\b"), ("hercules", r"hercules"), ("ophiuchus", r"ophiuchus"),
    ("eridanus", r"eridanus"), ("carina", r"carina|argo navis"), ("puppis", r"puppis"),
    ("vela", r"\bvela\b"), ("pyxis", r"pyxis"), ("draco", r"\bdraco\b"),
    ("crater", r"crater"), ("serpens", r"serpens"), ("sagitta", r"\bsagitta\b"),
    ("tucana", r"tucana"), ("pavo", r"\bpavo\b"), ("phoenix", r"phoenix"),
    ("columba", r"columba"), ("lepus", r"\blepus\b"), ("lynx", r"\blynx\b"),
    ("hydra", r"\bhydra\b"), ("equuleus", r"equuleus"), ("fornax", r"fornax"),
    ("horologium", r"horologium"), ("mensa", r"\bmensa\b"),
    ("microscopium", r"microscopium"), ("telescopium", r"telescopium"),
    ("musca", r"\bmusca\b"), ("octans", r"octans"), ("antlia", r"antlia"),
    ("caelum", r"caelum"), ("camelopardalis", r"camelopard"),
    ("chamaeleon", r"chamaeleon"), ("circinus", r"circinus"),
    ("coma-berenices", r"coma berenices"), ("sculptor", r"sculptor"),
    ("scutum", r"scutum"), ("reticulum", r"reticulum"), ("pictor", r"pictor"),
    ("sextans", r"sextans"), ("volans", r"volans"), ("vulpecula", r"vulpecula"),
